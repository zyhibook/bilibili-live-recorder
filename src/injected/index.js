      ...
      this.worker.onmessage = function (event) {
        ...
        switch (type) {
          case 'report':
            ...
            _this.$size.textContent = data.size + 'M';
            break;
